                                    ...
                                    <div className="entry cursor-pointer transform hover:scale-105 duration-300 transition-transform bg-white mb-4 rounded p-4 flex shadow-md">
                                        <div className="flex-2">
                                            <div className="w-12 h-12 relative">
                                                <Image width={100} height={100} className="w-12 h-12 rounded-full mx-auto" src="https://images.pexels.com/photos/3845457/pexels-photo-3845457.jpeg?auto=compress&cs=tinysrgb&dpr=2&w=100" alt="chat-user" />
                                ...
                                <div className="sticky bottom-24">
                                    <div className="write bg-white shadow flex rounded-lg">
                                        ...
                                        <div className="flex-1">
                                            <textarea name="message" className="w-full block outline-none py-2 px-2 bg-transparent" placeholder="Type a message..."></textarea>
                                        </div>
